...
Through data analysis of campaign donations since 2015, 538 found that major league sports team owners contribute more heavily to Republican candidates and PACs than Democratic in federal elections. The WNBA is the only league that leans more heavily Democratic. Looking specifically at the 2020 presidential election, Joe Biden received a greater number of donations from owners but a smaller overall sum, and Donald Trump received fewer donations but a larger overall sum. 

This was 538’s first article using this dataset in a series of six publications. The authors present the main findings of their analysis and the entire story is grounded with key figures that they found in the data. This data-driven approach is effective, if a little dry.  We were left wanting one or two case studies that looked more closely at some of the standout figures. It’s possible that the follow up articles in the series looked at particular owners in depth or wove more of a narrative than this initial overview. This reporting is in step with what we know to be 538’s style, which is grounded in data analysis more than fieldwork or interviews. 

The reporters supplemented the text of the article with multiple visual aids. For comparison across the three election cycles, they used primarily bar graphs with bright blue clearly representing Democratic donations and bright red representing Republican. They also used simple black and white charts to compare giving across leagues. The article concludes with an interactive table that allows readers to sort by column as well as a search bar to look up particular owners and teams that interest them. That was a very helpful device in our opinion, since readers are likely to want to look into the teams they support or famous owners in particular. 

We thought that another opportunity to improve 538’s analysis would have been to include the demographic information of owners. The reporters allude to the fact that owners skew older and whiter than the US population, but the data to back that claim is not included in the dataset. It seemed to us that perhaps it would be better to omit that detail than leave it hanging without support. 

The reporters did communicate several flaws in their data. One that interested us was “If a contribution appeared to be from an owner but could not be confirmed, it was not included. And, as is the case with many millionaires and billionaires, owners have a number of ways to hide their political spending.” They touch on this topic in greater detail in a follow up article in the series, “Dark money and why owners hide their political spending.” Another shortcoming is that this article was published October 28, 2020, a week before polls closed in the 2020 election, so some contributions are missing. They write, “Some of the big super PACs had filed only individual contributor data to the FEC as of June 30, meaning their most recent contributions aren’t included in our totals.” 

On the whole, 538’s analysis of sports owners' political contributions is transparent and easy to replicate. In our final finding, however, we did struggle to see their method for determining which PACs supported Biden versus Trump in the 2020 presidential election. There was not a way to filter out the many PACs in the dataset that supported congressional candidates. While it is possible and helpful to filter the PACs by party, there were still PACs with ambiguous names like “Unite the County” and “AB PAC” that turned out to be key to replicating Finding 5. It was unclear to us how the 538 team went about designating a PAC as for Biden or for Trump. 

In the README file that accompanied the dataset, 538 states only that “The data is from the Federal Election Commission and OpenSecrets.” They do not provide further detail on how they found the data, combined data from the FEC and OpenSecrets, or how much they cleaned it. It seemed to us, however, that extensive work likely went into cleaning the dataset. It appeared to be free of major errors that would impact our ability to use it and overall their findings were easy to replicate. All that we had to do was clean column names, convert the format of the donation amounts to a number and capitalize the recipients for ease of searching. 
